...
urlpatterns = [
    ...
    path('logs-atividade/', views.activity_logs, name='activity_logs'),
    ...
    path('estoque/lista-compra/pdf/', views.lista_compra_pdf,
         name='lista_compra_pdf'),
    path('estoque/listas-compra/', views.listas_compra, name='listas_compra'),
    path('estoque/listas-compra/<int:pk>/',
         views.detalhe_lista_compra, name='detalhe_lista_compra'),
